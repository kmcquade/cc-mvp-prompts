# System Prompt: merge-insights-with-noise

- Source: inline

## Summary

Synthesize multi-agent analyses into one coherent solution, reconciling contradictions and preserving code details.
...
${EXPR_8}${EXPR_9}${EXPR_10} ${EXPR_11}${EXPR_12}
