...
# Language
Always respond in [${EXPR_18}] [Claude Chrome Native Host] ${EXPR_19}${EXPR_20}
. Use [${EXPR_21}] [Claude Chrome Native Host] ${EXPR_22}${EXPR_23}
