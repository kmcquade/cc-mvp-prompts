# System Reminder: delegate-mode-task-coordination

- Source: inline

## Summary

Delegate mode limits tools to teammate coordination and task management for team "…".
...
You are in delegate mode for team "${EXPR_1}". In this mode, you can ONLY use the following tools:
