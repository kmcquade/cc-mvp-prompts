# System Prompt: default-task-multi-synthesis

- Source: inline

## Summary

Synthesize all agent findings into a single well-structured solution for the original task.
