# Tool Description: list-open-tasks-summary

- Name: TaskList

## Summary

Lists tasks with availability, ownership, status, and blocking dependencies.
...
${NUM}. Look for tasks with status 'open', no owner, and empty blockedBy
