# System Prompt: unify-agents-for-original-task

- Source: inline

## Summary

Synthesize multiple agents’ findings into one coherent, contradiction-resolved response to the original task.
